...
function install_eza() {
  ...
  local local_version=$(command -v eza &>/dev/null && fzf --version | awk '{print $1}' || echo "0.0.0")
  local download_url="https://github.com/eza-community/eza/releases/download/$remote_version/eza_${ARCH}-unknown-${OS}-gnu.tar.gz"
